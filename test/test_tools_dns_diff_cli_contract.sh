...
FAKE_SMARTDNS_BUILD_ROOT="$WORKDIR/smartdns-build"
FAKE_SMARTDNS_BUILD_TREE="$FAKE_SMARTDNS_BUILD_ROOT"
FAKE_SMARTDNS_TARGET="$FAKE_SMARTDNS_BUILD_ROOT/smartdns-build/src/smartdns"
FAKE_SMARTDNS_HARNESS="$WORKDIR/smartdns-harness.py"
FAKE_MARADNS_BUILD_ROOT="$WORKDIR/maradns-build"
FAKE_MARADNS_BUILD_TREE="$FAKE_MARADNS_BUILD_ROOT"
FAKE_MARADNS_TARGET="$FAKE_MARADNS_BUILD_ROOT/deadwood-build/deadwood-github/src/Deadwood"
